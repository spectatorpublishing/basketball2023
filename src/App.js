  ...
  return (
    <Router basename={process.env.PUBLIC_URL}>
      ...
      <Switch>
        ...
        <Route exact path='/all' render={() => <Section current="all" id="all" header="ALL BASKETBALL" mendata={mendata} womendata={womendata} next="Women's Basketball" link="/womens" key={3}/>} />
      </Switch>
    </Router>
  );
}
